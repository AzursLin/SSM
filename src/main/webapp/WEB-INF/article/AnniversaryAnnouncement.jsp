...
<script type="text/javascript">
    ...
    function getMsgDetail(obj){
        var id =  obj.id;
        var str = "/article/announcement/update/"+id;
        $.ajax({
            type:"GET",
            url:str,
            dataType: "json",
    ...
    function submitarticle(){
        if($("#title").val() == null){
            ...
            $.ajax({
                type:'POST',
                url:"/article/sumbit/",
                data: {title:$("#title").val(), content:content,type:"announcement",action:action,id:nowID},
                dataType: "json",
                success: function (data)
                {
    ...
    function deleteMsg(obj){
        $.ajax({
            type:'POST',
            url:"/article/sumbit/",
            data: {title:null, content:null,type:"announcement",action:"delete",id:obj.id},
            dataType: "json",
            success: function (data)
            {
